...
def extarct_from_response_enq(user_input):
    ...
    try:
        if user_input.lower() == "refresh":
            ...
            keys_to_extract = ["enquiry_number", "quotation", "status", "shipment_type",  "prospect", "origin", "destination"]
